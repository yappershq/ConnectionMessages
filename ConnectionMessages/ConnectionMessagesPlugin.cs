...
/// <summary>
/// ConnectionMessages — custom join/leave announcements with cross-plugin suppression API.
/// </summary>
public sealed class ConnectionMessagesPlugin : IModSharpModule
{
    public string DisplayName   => "ConnectionMessages";
    public string DisplayAuthor => "yappershq";

    private readonly ILogger<ConnectionMessagesPlugin> _logger;
    private readonly ServiceProvider                   _serviceProvider;

    public ConnectionMessagesPlugin(
        ...
        bool            hotReload)
    {
        ...
        _logger = loggerFactory.CreateLogger<ConnectionMessagesPlugin>();
    ...
    {
        // Provide the plugin reference to InterfaceBridge so RegisterSharpModuleInterface can use it.
        InterfaceBridge.Instance.SetPlugin(this);
    ...
    public void OnAllModulesLoaded()
    {
        ...
        _logger.LogInformation("[ConnectionMessages] Plugin loaded successfully");
    }
    ...
    private void CallSafe(IModule module, Action<IModule> action, string phase)
    {
        ...
        {
            _logger.LogError(ex, "[ConnectionMessages] Error in {Phase} for {Module}", phase, module.GetType().Name);
        }
    }
}
